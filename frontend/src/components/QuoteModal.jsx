        ...
        <form onSubmit={onSubmit} className="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
          <div className="grid sm:grid-cols-2 gap-4">
            <label className="block text-sm">
              ...
              <input
                ...
                value={form.name}
                onChange={onChange}
                className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm focus:ring-2 focus:ring-brand-sky/40 focus:border-brand-sky outline-none"
                autoComplete="name"
              />
            </label>
            <label className="block text-sm">
          ...
          <label className="block text-sm">
            ...
            <select
              ...
              value={form.service}
              onChange={onChange}
              className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm bg-white focus:ring-2 focus:ring-brand-sky/40 focus:border-brand-sky outline-none"
            >
          ...
          <label className="block text-sm">
            ...
            <textarea
              ...
              className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm focus:ring-2 focus:ring-brand-sky/40 focus:border-brand-sky outline-none resize-y min-h-[88px]"
            />
          </label>
          <label className="block text-sm">
            ...
            <input
              ...
              value={form.location}
              onChange={onChange}
              placeholder="Area / city in Pakistan (e.g. Lahore DHA, Islamabad F-10)"
              className="mt-1 w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm focus:ring-2 focus:ring-brand-sky/40 focus:border-brand-sky outline-none"
            />
          </label>
          {status.message && (
          ...
          <div className="flex flex-col-reverse sm:flex-row gap-3 sm:justify-end pt-1">
            ...
            <button
              ...
              className="rounded-xl px-5 py-2.5 text-sm font-semibold text-white bg-brand-orange hover:bg-brand-sky disabled:opacity-60 shadow-md"
            >
