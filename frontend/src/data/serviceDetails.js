...
export const serviceCategories = [
  {
    ...
    summary: 'From grey structure to finishing — built to last in Pakistan’s climate.',
  ...
  },
  {
    id: 'plumbing',
    title: 'Plumbing',
    summary: 'Installations, upgrades, and emergency leak response across Pakistan.',
    image: img.plumbing,
    items: [
      {
