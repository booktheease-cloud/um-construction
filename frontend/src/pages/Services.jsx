...
import { serviceCategories as fallbackServices } from '../data/serviceDetails'
...
export default function Services() {
  ...
  const [categories, setCategories] = useState(fallbackServices)
      ...
      <section className="bg-brand-navy text-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-14 sm:py-16">
          ...
          <p className="mt-4 text-slate-300 max-w-2xl">
            Each category below includes common scopes we deliver across Pakistan — with clear
